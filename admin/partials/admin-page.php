...
<div class="wrap">
	<form id="bbpress_shortcodes_options" action="options.php" method="post">
		...
		<div id="after-submit">
			...
			<p>
				<?php esc_html_e( 'Access Plugin Documentation on', 'bbpress-shortcodes' ); ?> <a href="http://nexgenforo.org/plugins/bbpress-shortcodes/" target="_blank">http://nexgenforo.org/plugins/bbpress-shortcodes/</a>
			</p>
		</div>
	 </form>
</div>
