	...
	class BBPS_Admin {
		...
		function plugin_settings_link( $links, $file ) {
			if ( false !== strpos( $file, 'bbpress-shortcodes' ) ) {
				$mylinks = array(
					'<a href="http://nexgenforo.org/support/bbpress-plugins/bbpress-shortcodes/">' . esc_html__( 'Get Support', 'bbpress-shortcodes' ) . '</a>',
		...
		function setup_notice(){
			...
			if ( $hascaps ) {
				...
				echo '<div class="notice notice-info is-dismissible bbpress-shortcodes"><p>' . sprintf( __( 'To configure <em>bbPress Shortcodes plugin</em> please visit its <a href="%1$s">configuration page</a> and to get plugin support contact us on <a href="%2$s" target="_blank">plugin support forum</a> or <a href="%3$s" target="_blank">contact us page</a>.', 'bbpress-shortcodes'), $url . 'wp-admin/options-general.php?page=bbpress_shortcodes', 'http://nexgenforo.org/support/bbpress-plugins/bbpress-shortcodes/', 'http://nexgenforo.org/contact/' ) . '</p></div>';
			}
		}
